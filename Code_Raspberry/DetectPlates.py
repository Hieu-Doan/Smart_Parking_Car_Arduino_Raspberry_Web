...
PLATE_WIDTH_PADDING_FACTOR = 1.5#1.3
PLATE_HEIGHT_PADDING_FACTOR = 1.3 #1.5 
...
def detectPlatesInScene(imgOriginalScene):
    ...
    #cv2.destroyAllWindows()    #this can be close all window of def check_empty_parking_car()
